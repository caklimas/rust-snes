...
pub fn ora_immediate(cpu: &mut Cpu, bus: &mut Bus) -> u8 {
...
pub fn ora_direct(cpu: &mut Cpu, bus: &mut Bus) -> u8 {
...
pub fn ora_absolute(cpu: &mut Cpu, bus: &mut Bus) -> u8 {
...
pub fn ora_direct_x(cpu: &mut Cpu, bus: &mut Bus) -> u8 {
    let offset = read_offset_byte(cpu, bus);
...
pub fn ora_absolute_x(cpu: &mut Cpu, bus: &mut Bus) -> u8 {
...
pub fn ora_absolute_y(cpu: &mut Cpu, bus: &mut Bus) -> u8 {
...
pub fn ora_indirect_x(cpu: &mut Cpu, bus: &mut Bus) -> u8 {
...
pub fn ora_indirect_y(cpu: &mut Cpu, bus: &mut Bus) -> u8 {
...
pub fn ora_indirect(cpu: &mut Cpu, bus: &mut Bus) -> u8 {
