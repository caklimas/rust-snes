...
pub fn eor_immediate(cpu: &mut Cpu, bus: &mut Bus) -> u8 {
    let (pc_increment, cycles) = if is_8bit_mode_m(cpu) {
        let value = read_offset_byte(cpu, bus);
        perform_eor_u8(cpu, value.try_into().unwrap());
        (2, 2)
    } else {
...
pub fn eor_direct(cpu: &mut Cpu, bus: &mut Bus) -> u8 {
...
pub fn eor_absolute(cpu: &mut Cpu, bus: &mut Bus) -> u8 {
...
pub fn eor_direct_x(cpu: &mut Cpu, bus: &mut Bus) -> u8 {
    let offset = read_offset_byte(cpu, bus);
...
pub fn eor_absolute_x(cpu: &mut Cpu, bus: &mut Bus) -> u8 {
...
pub fn eor_absolute_y(cpu: &mut Cpu, bus: &mut Bus) -> u8 {
...
pub fn eor_indirect_x(cpu: &mut Cpu, bus: &mut Bus) -> u8 {
...
pub fn eor_indirect_y(cpu: &mut Cpu, bus: &mut Bus) -> u8 {
...
pub fn eor_indirect(cpu: &mut Cpu, bus: &mut Bus) -> u8 {
