...
pub fn pha<B: MemoryBus>(cpu: &mut Cpu, bus: &mut B) -> u8 {
...
pub fn phx<B: MemoryBus>(cpu: &mut Cpu, bus: &mut B) -> u8 {
...
pub fn phy<B: MemoryBus>(cpu: &mut Cpu, bus: &mut B) -> u8 {
    let cycles = if is_8bit_mode_x(cpu) {
...
pub fn php<B: MemoryBus>(cpu: &mut Cpu, bus: &mut B) -> u8 {
...
pub fn phb<B: MemoryBus>(cpu: &mut Cpu, bus: &mut B) -> u8 {
...
pub fn phk<B: MemoryBus>(cpu: &mut Cpu, bus: &mut B) -> u8 {
...
pub fn pla<B: MemoryBus>(cpu: &mut Cpu, bus: &mut B) -> u8 {
    let cycles = if is_8bit_mode_m(cpu) {
...
pub fn plx<B: MemoryBus>(cpu: &mut Cpu, bus: &mut B) -> u8 {
    let cycles = if is_8bit_mode_x(cpu) {
        let value = pull_byte(cpu, bus);
...
pub fn ply<B: MemoryBus>(cpu: &mut Cpu, bus: &mut B) -> u8 {
    let cycles = if is_8bit_mode_x(cpu) {
        let value = pull_byte(cpu, bus);
...
pub fn plp<B: MemoryBus>(cpu: &mut Cpu, bus: &mut B) -> u8 {
    let value = pull_byte(cpu, bus);
...
pub fn plb<B: MemoryBus>(cpu: &mut Cpu, bus: &mut B) -> u8 {
    let value = pull_byte(cpu, bus);
