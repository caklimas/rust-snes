...
pub fn execute_opcode<B: MemoryBus>(cpu: &mut Cpu, bus: &mut B, opcode: u8) -> u8 {
    ...
    match opcode {
        ...
        0x47 => eor::eor_direct_indirect_long(cpu, bus),
